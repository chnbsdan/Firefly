...
export const siteConfig: SiteConfig = {
  ...
  favicon: [
    // 留空以使用默认 favicon
    {
      src: "https://img.hangdn.com/hexo/handan.ico", // 图标文件路径
  ...
  navbarLogo: {
    type: "image",
    value: "/assets/images/hangdn.png",
    alt: "🍀",
  },
  navbarTitle: "Hangdn blog", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
